...
def augment_and_save(input_image, output_directory, output_prefix):
    ...
    for i in tqdm(range(60), desc='Augmenting images', unit='image'):
        # Variasi warna saja atau distorsi elastis saja
        augment_choice = np.random.choice([change_color, elastic_distortion], p=[0.5, 0.5])
        augmented_image = augment_choice(input_image)
...
if __name__ == "__main__":
    input_image_path = "faces/real_face/sigit.jpg"
    output_directory = "faces/augmented/"
    output_prefix = "sigit"
